...
class SubmissionController extends Controller
{
    ...
    {
        // Guests can start the submission process, but must login to finalize.
    ...
    public function store(Request $request, Journal $journal)
    {
        ...
        $validated = $request->validate([
            ...
            'title_page' => ['nullable', 'file', 'mimes:doc,docx,pdf', 'max:5120'],
    ...
    public function show(Submission $submission)
    {
        ...
        $submission->load(['journal', 'authors', 'files', 'reviews', 'logs', 'issue', 'discussionThreads', 'galleys']);
