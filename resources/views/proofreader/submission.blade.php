                        ...
                        <li>
                            <div class="flex items-center">
                                ...
                                <a href="{{ route('proofreader.dashboard') }}"
                                    class="text-sm font-medium text-gray-500 hover:text-cisa-base">Proofreader Dashboard</a>
                            </div>
                        </li>
                    ...
                    <div
                        ...
                        <div class="relative z-10 flex items-start gap-4">
                            <div
                                ...
                                <i class="fas fa-glasses text-cisa-accent text-xl"></i>
                            </div>
                            <div>
                                <h2 class="text-xl font-serif font-bold mb-2 text-white">Proofreading Instructions</h2>
                                <p class="text-gray-300 text-sm leading-relaxed mb-4">
                                    Please review the final manuscript files for typos, formatting consistency, and
                                    grammatical errors. Ensure that the layout matches the journal's standards before final
                                    publication.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="p-6">
                            ...
                            @else
                                <div class="text-center py-12 bg-gray-50 rounded-xl border border-dashed border-gray-300">
                                    ...
                                    <p class="text-gray-500 font-medium">No files available for proofreading.</p>
                                </div>
                            @endif
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                        <div class="bg-gray-50 px-6 py-4 border-b border-gray-100">
                            <h3 class="text-lg font-serif font-bold text-cisa-base flex items-center">
                                ...
                                Submit Proofread Version
                            </h3>
                        </div>
                        <div class="p-6">
                            <form method="POST" action="{{ route('proofreader.submissions.upload', $submission) }}"
                                ...
                                <div class="mb-8">
                                    ...
                                    <textarea name="notes" rows="4"
                                        ...
                                        placeholder="Describe any major changes or remaining issues..."></textarea>
                                </div>
                                ...
                                <div class="flex items-center gap-4">
                                    <button type="submit"
                                        ...
                                        <i class="fas fa-check-circle mr-2"></i> Submit Proofread File
                                    </button>
                                    <a href="{{ route('proofreader.dashboard') }}"
