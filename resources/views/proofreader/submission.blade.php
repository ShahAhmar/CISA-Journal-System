...
@section('title', 'Proofreading - ' . $submission->title)
...
<div class="min-h-screen bg-gray-50 py-8">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <!-- Header -->
        <div class="mb-6">
            <a href="{{ route('proofreader.dashboard') }}" class="text-[#0056FF] hover:text-[#0044CC] inline-flex items-center mb-4">
        ...
        <div class="bg-white rounded-xl shadow-lg border-2 border-gray-200 p-6 mb-6">
            <div class="flex items-center justify-between mb-4">
                ...
                <div class="bg-indigo-100 px-4 py-2 rounded-lg">
                    <span class="text-indigo-800 font-semibold">Stage: Proofreading</span>
                </div>
            </div>
            ...
            <div class="bg-blue-50 border-l-4 border-blue-500 p-4 rounded-lg">
                <p class="text-sm text-blue-800">
                    ...
                    <strong>Note:</strong> Please review the final files for typos, formatting errors, and other issues before publication.
                </p>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-lg border-2 border-gray-200 p-6 mb-6">
            <h2 class="text-xl font-bold text-[#0F1B4C] mb-4 flex items-center">
                <i class="fas fa-file-pdf text-[#0056FF] mr-3"></i>Files to Proofread
            </h2>
                            ...
                            <div class="flex items-center">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-500">
                                        {{ ucfirst($file->file_type) }} • Version {{ $file->version }} • {{ number_format($file->file_size / 1024, 2) }} KB
                                    </p>
                                </div>
                            </div>
        ...
        <div class="bg-white rounded-xl shadow-lg border-2 border-gray-200 p-6">
            <h2 class="text-xl font-bold text-[#0F1B4C] mb-4 flex items-center">
                <i class="fas fa-upload text-[#0056FF] mr-3"></i>Upload Proofread File
            </h2>
            
            <form method="POST" action="{{ route('proofreader.submissions.upload', $submission) }}" enctype="multipart/form-data">
                @csrf
                
                <div class="mb-6">
                    <label class="block text-sm font-semibold text-gray-700 mb-2">
                        Proofread File * <span class="text-gray-500">(PDF, DOC, or DOCX)</span>
                    </label>
                ...
                <div class="mb-6">
                    ...
                    <textarea name="notes" rows="4" 
                              class="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:outline-none focus:border-[#0056FF]"
                              placeholder="Add any notes about corrections made..."></textarea>
                </div>
                ...
                <div class="flex gap-4">
                    ...
                    <button type="submit" 
                        ...
                        <i class="fas fa-upload mr-2"></i>Upload Proofread File
                    </button>
                </div>
            </form>
        </div>
