...
@section('title', 'Proofreader Dashboard - EMANP')
            ...
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-bold text-[#0F1B4C]">
                        <i class="fas fa-check-double mr-3 text-[#0056FF]"></i>Proofreader Dashboard
                    </h1>
                    <p class="text-gray-600 mt-2">Manage proofreading tasks for assigned submissions</p>
                </div>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-blue-50 transition-colors">
                            ...
                            <td class="px-6 py-4">
                                <span class="px-3 py-1 rounded-full text-xs font-semibold
                                    {{ $submission->current_stage === 'proofreading' ? 'bg-blue-100 text-blue-800' : 'bg-gray-100 text-gray-800' }}">
                                    {{ ucfirst($submission->current_stage) }}
                                </span>
                            </td>
                            <td class="px-6 py-4 text-sm text-gray-700">
                                {{ $submission->proofreading_due_date ? $submission->proofreading_due_date->format('M d, Y') : 'N/A' }}
                            </td>
                        ...
                        <tr>
                            <td colspan="6" class="px-6 py-12 text-center">
                                ...
                                <p class="text-gray-400">You'll see proofreading tasks here when assigned</p>
                            </td>
                        </tr>
                        @endforelse
                    </tbody>
