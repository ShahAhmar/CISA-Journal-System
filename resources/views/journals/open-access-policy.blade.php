...
@section('title', $journal->name . ' - Open Access Policy | EMANP')
...
<section class="bg-gradient-to-br from-[#0F1B4C] via-[#1D72B8] to-[#0F1B4C] text-white py-16 relative overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div class="text-center">
            ...
            <h2 class="text-2xl md:text-3xl font-semibold text-blue-200 mb-2">Open Access Policy</h2>
            <p class="text-lg text-blue-100 max-w-3xl mx-auto">
                Our commitment to open and accessible research
            </p>
        </div>
    </div>
</section>
...
<div class="bg-white border-b border-gray-200">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        <nav class="flex items-center space-x-2 text-sm">
            ...
            <i class="fas fa-chevron-right text-gray-400 text-xs"></i>
            <span class="text-gray-600">Open Access Policy</span>
        </nav>
    </div>
</div>
    ...
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="bg-white rounded-2xl shadow-xl border-2 border-gray-100 p-8 md:p-12">
            ...
            @else
                <div class="text-center py-12">
                    <i class="fas fa-unlock text-gray-400 text-6xl mb-4"></i>
                    <h3 class="text-2xl font-bold text-gray-700 mb-2">Open Access Policy Coming Soon</h3>
                    <p class="text-gray-600 mb-6">Detailed open access policy will be available soon.</p>
                </div>
            @endif
        </div>
        ...
        <div class="mt-8 flex flex-wrap justify-center gap-4">
            ...
            <a href="{{ route('journals.peer-review-policy', $journal) }}" 
               class="btn bg-white hover:bg-gray-50 text-[#0F1B4C] border-2 border-[#0F1B4C] px-8 py-3 rounded-lg font-semibold transition-colors">
                <i class="fas fa-check-circle mr-2"></i>Peer Review Policy
            </a>
        </div>
    </div>
</section>
