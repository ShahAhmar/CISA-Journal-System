...
@section('title', $journal->name . ' - Contact Us | CISA')
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
                ...
                <div class="space-y-8">
                    ...
                    <div class="grid gap-6">
                        @if($journal->primary_contact_email)
                            <div
                                ...
                                <div>
                                    ...
                                    @if($journal->primary_contact_name)
                                        <p class="text-sm text-cisa-base font-bold mb-1">{{ $journal->primary_contact_name }}</p>
                                    @endif
                                    <p class="text-sm text-gray-500 mb-2">Primary Contact for queries</p>
                                    <a href="mailto:{{ $journal->primary_contact_email }}"
                                        class="text-cisa-accent font-bold hover:text-cisa-base transition-colors">
                                        {{ $journal->primary_contact_email }}
                                    </a>
                                </div>
                            </div>
                        @endif
