...
@section('title', 'CISA Interdisciplinary Journal (CIJ) - Premier Academic Publishing Platform')
...
@section('content')
    ...
    <section class="relative min-h-[85vh] flex items-center justify-center overflow-hidden bg-cisa-base">
        ...
        <div class="absolute inset-0 z-0">
            <img src="{{ asset('assets/images/portal-hero.png') }}"
            ...
            <div class="grid grid-cols-2 lg:grid-cols-4 gap-6 max-w-4xl mx-auto border-t border-white/10 pt-12 animate-slide-up"
                ...
                <div class="text-center group px-4">
                    <div class="text-xl font-bold text-white font-serif mb-0.5">
                        {{ \App\Models\Journal::where('is_active', true)->count() }}</div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            @if($journals->count() > 0)
                        ...
                        <div
                                    ...
                                    <div class="flex items-center gap-2">
                                        ...
                                        <div>
                                            ...
                                            <div class="text-white font-bold text-lg leading-none">
                                                {{ number_format($journal->impact_factor ?? 2.5, 2) }}</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="p-8 pb-10 flex-grow flex flex-col bg-white relative">
                                ...
                                <p class="text-gray-500 text-sm mb-8 flex-grow leading-relaxed font-light italic">
                                    "{{ Str::limit(strip_tags($journal->description ?: 'International peer-reviewed journal dedicated to advancing knowledge across global disciplines.'), 120) }}"
                                </p>
                ...
                <div class="text-center mt-16">
                    <a href="{{ route('journals.index') }}" class="btn-cisa-outline text-lg px-10 py-4">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-6">
                ...
                @foreach($subjects as $subject)
                    <a href="{{ route('search', ['category' => $subject['label']]) }}"
                        ...
                        <div
                            ...
                            <i class="fas {{ $subject['icon'] }} text-lg"></i>
                        </div>
                        <span
                            class="text-xs font-bold text-gray-600 group-hover:text-cisa-base uppercase tracking-widest transition-colors">{{ $subject['label'] }}</span>
                    </a>
                @endforeach
            </div>
        </div>
