...
<div class="bg-white border-b border-gray-200">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        <nav class="flex items-center space-x-2 text-sm">
            <a href="{{ route('journals.index') }}" class="text-cisa-accent hover:text-amber-600 transition-colors">
                <i class="fas fa-home"></i> Home
            </a>
            <i class="fas fa-chevron-right text-gray-400 text-xs"></i>
            <a href="{{ route('journals.show', $journal) }}" class="text-cisa-accent hover:text-amber-600 transition-colors">
        ...
        <form method="POST" action="{{ route('author.submissions.store', $journal) }}" enctype="multipart/form-data" id="submissionForm" @submit.prevent="submitForm">
                ...
                <div class="mb-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <label class="flex items-center p-4 border-2 rounded-lg cursor-pointer transition-all hover:border-[#0056FF] hover:bg-blue-50"
                               :class="formData.journal_section_id == {{ $section->id }} ? 'border-cisa-accent bg-amber-50' : 'border-gray-200'">
                            <input type="radio" name="journal_section_id" value="{{ $section->id }}" 
                                   ...
                                   class="mr-3">
                            <div class="flex-1">
                                <div class="font-semibold text-cisa-base">{{ $section->title }}</div>
            ...
            <div x-show="currentStep === 1" class="bg-white rounded-2xl shadow-xl border-2 border-gray-100 p-8 md:p-12">
                ...
                <div class="mb-6">
                    ...
                    <div class="border-2 border-dashed rounded-lg p-6 hover:border-cisa-accent transition-colors bg-slate-50 {{ $errors->has('manuscript') ? 'border-red-500' : 'border-gray-300' }}">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" id="title" name="title" required 
                               ...
                               value="{{ old('title', '') }}"
                               class="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:outline-none focus:border-cisa-accent transition-colors text-gray-900 {{ $errors->has('title') ? 'border-red-500' : '' }}"
