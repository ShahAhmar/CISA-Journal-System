...
@section('title', 'Publish With Us - CISA Interdisciplinary Journal')
                        ...
                        <div
                            ...
                            <div class="h-40 bg-cisa-light relative flex items-center justify-center overflow-hidden">
                                ...
                                <h3 class="absolute bottom-4 left-6 right-6 text-lg font-bold text-white font-serif leading-tight">
                                    {{ Str::limit($journal->name, 50) }}
                                </h3>
                            </div>
                            <div class="p-6">
                                <p class="text-gray-600 text-sm mb-6 line-clamp-3">
                                    {{ Str::limit($journal->description ?? 'Submission open for this journal.', 100) }}
                                </p>
                                <a href="{{ route('login') }}"
