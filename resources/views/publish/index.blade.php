...
@section('title', 'Publish With Us - CISA Interdisciplinary Journal (CIJ)')
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div class="text-center">
            ...
            <div class="flex flex-wrap justify-center gap-4">
                ...
                <a href="{{ route('journals.index') }}" class="bg-white/10 hover:bg-white/20 text-white px-8 py-4 rounded-xl font-semibold text-lg border-2 border-white/30 transition-all duration-200">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
            <div class="text-center">
                <div class="text-4xl md:text-5xl font-bold text-purple-700 mb-2" style="font-family: 'Playfair Display', serif;">
                    {{ number_format($stats['total_journals'] ?? 0) }}+
                </div>
                <div class="text-gray-600 font-semibold">Active Journals</div>
            </div>
            <div class="text-center">
                <div class="text-4xl md:text-5xl font-bold text-purple-700 mb-2" style="font-family: 'Playfair Display', serif;">
                    {{ number_format($stats['total_articles'] ?? 0) }}+
                </div>
...
<section id="journals" class="bg-gradient-to-br from-purple-50 via-white to-purple-50 py-16">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                @foreach($journals as $journal)
                    <div class="bg-white rounded-2xl border border-gray-200 hover:border-purple-300 hover:shadow-xl transition-all duration-300 overflow-hidden transform hover:scale-[1.01]">
                        ...
                        <div class="p-6 bg-white">
                            <h3 class="text-xl font-bold text-gray-900 mb-3 min-h-[3rem] leading-tight" style="font-family: 'Playfair Display', serif;">{{ $journal->name }}</h3>
                            <p class="text-gray-600 text-sm mb-4 line-clamp-2">{{ Str::limit($journal->description, 100) }}</p>
                            <a href="{{ route('journals.show', $journal) }}" class="block w-full bg-gradient-to-r from-purple-600 to-purple-700 hover:from-purple-700 hover:to-purple-800 text-white text-center py-3 rounded-xl font-semibold transition-colors shadow-md hover:shadow-lg">
                                View Journal
                            </a>
                        </div>
                    </div>
        ...
        <div class="text-center mt-12">
            <a href="{{ route('journals.index') }}" class="bg-gradient-to-r from-purple-600 to-purple-700 hover:from-purple-700 hover:to-purple-800 text-white px-8 py-4 rounded-xl font-semibold text-lg transition-colors shadow-lg transform hover:scale-105 inline-block">
...
<section class="bg-gradient-to-br from-purple-900 via-purple-800 to-purple-900 text-white py-16 relative overflow-hidden">
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        ...
        <div class="flex flex-wrap justify-center gap-4">
            @auth
                <a href="{{ route('journals.index') }}" class="bg-white hover:bg-gray-100 text-purple-800 px-8 py-4 rounded-xl font-semibold text-lg transition-colors shadow-xl transform hover:scale-105">
                    <i class="fas fa-book-open mr-2"></i>Browse Journals
                </a>
            @else
                <a href="{{ route('register') }}" class="bg-gradient-to-r from-purple-600 to-purple-700 hover:from-purple-700 hover:to-purple-800 text-white px-8 py-4 rounded-xl font-semibold text-lg transition-colors shadow-xl transform hover:scale-105">
                    <i class="fas fa-user-plus mr-2"></i>Create Account
                </a>
                <a href="{{ route('login') }}" class="bg-white bg-opacity-10 hover:bg-opacity-20 text-white px-8 py-4 rounded-xl font-semibold text-lg transition-colors border-2 border-white border-opacity-30">
