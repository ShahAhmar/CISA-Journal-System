...
@section('title', 'Create Subscription - EMANP')
@section('page-title', 'Create Subscription')
@section('page-subtitle', 'Create a new subscription')
        ...
        <div class="space-y-6">
            ...
            <div>
                ...
                <textarea name="notes" rows="3" 
                          class="w-full px-4 py-2 border-2 border-gray-200 rounded-lg focus:outline-none focus:border-[#0056FF]">{{ old('notes') }}</textarea>
            </div>
