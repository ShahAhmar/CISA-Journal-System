...
@section('title', 'Admin Dashboard - EMANP')
@section('page-title', 'Admin Dashboard')
@section('page-subtitle', 'Overview of your journal publishing platform')

@section('content')
<!-- Stats Cards -->
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-6 gap-6 mb-8">
    <!-- Total Journals -->
    <a href="{{ route('admin.journals.index') }}" class="bg-white rounded-xl p-6 border-2 border-gray-200 hover:border-[#0056FF] hover:shadow-xl transition-all duration-300 cursor-pointer block">
    ...
    <!-- Active Journals -->
    <a href="{{ route('admin.journals.index') }}" class="bg-white rounded-xl p-6 border-2 border-gray-200 hover:border-green-500 hover:shadow-xl transition-all duration-300 cursor-pointer block">
        <div class="flex items-center justify-between mb-4">
    ...
    <!-- Total Users -->
    <a href="{{ route('admin.users.index') }}" class="bg-white rounded-xl p-6 border-2 border-gray-200 hover:border-blue-500 hover:shadow-xl transition-all duration-300 cursor-pointer block">
        <div class="flex items-center justify-between mb-4">
    ...
    <!-- Total Submissions -->
    <a href="{{ route('admin.submissions.index') }}" class="bg-white rounded-xl p-6 border-2 border-gray-200 hover:border-purple-500 hover:shadow-xl transition-all duration-300 cursor-pointer block">
        <div class="flex items-center justify-between mb-4">
    ...
    <!-- Pending Submissions -->
    <a href="{{ route('admin.submissions.index', ['status' => 'submitted']) }}" class="bg-white rounded-xl p-6 border-2 border-gray-200 hover:border-orange-500 hover:shadow-xl transition-all duration-300 cursor-pointer block">
        <div class="flex items-center justify-between mb-4">
    ...
    <!-- Published Articles -->
    <a href="{{ route('admin.submissions.index', ['status' => 'published']) }}" class="bg-white rounded-xl p-6 border-2 border-gray-200 hover:border-green-600 hover:shadow-xl transition-all duration-300 cursor-pointer block">
        <div class="flex items-center justify-between mb-4">
...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
    ...
    <div class="bg-white rounded-xl border-2 border-gray-200 p-6">
        <div class="flex items-center justify-between mb-6">
            ...
            <a href="{{ route('admin.journals.index') }}" class="text-[#0056FF] hover:text-[#0044CC] text-sm font-semibold transition-colors">
                ...
                @foreach($recentJournals as $journal)
                    <div class="flex items-center justify-between p-4 bg-[#F7F9FC] rounded-lg hover:bg-gray-50 transition-colors">
                        ...
                        <div class="flex items-center space-x-2">
                            ...
                            <a href="{{ route('admin.journals.edit', $journal) }}" class="text-[#0056FF] hover:text-[#0044CC] transition-colors" title="Edit">
        ...
        @else
            <div class="text-center py-8">
                ...
                <a href="{{ route('admin.journals.create') }}" class="text-[#0056FF] hover:text-[#0044CC] text-sm font-semibold mt-2 inline-block">
    ...
    <div class="bg-white rounded-xl border-2 border-gray-200 p-6">
        <div class="flex items-center justify-between mb-6">
            ...
            <a href="{{ route('admin.submissions.index') }}" class="text-[#0056FF] hover:text-[#0044CC] text-sm font-semibold transition-colors">
                View All <i class="fas fa-arrow-right ml-1"></i>
            </a>
        </div>
                        ...
                        @foreach($recentSubmissions as $submission)
                            <tr class="border-b border-gray-100 hover:bg-[#F7F9FC] transition-colors">
                                ...
                                <td class="py-3 px-4 text-sm text-gray-600">
                                    {{ $submission->author->full_name ?? 'N/A' }}
                                </td>
                                <td class="py-3 px-4 text-sm text-gray-600">
                                    {{ $submission->journal->name ?? 'N/A' }}
                                </td>
                                <td class="py-3 px-4">
                                ...
                                <td class="py-3 px-4">
                                    <a href="{{ route('admin.submissions.show', $submission) }}" class="text-[#0056FF] hover:text-[#0044CC] transition-colors text-sm" title="View Submission">
...
<div class="bg-white rounded-xl border-2 border-gray-200 p-6 mb-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        <!-- Review Requests -->
        <a href="{{ route('admin.reviews.index') }}?status=pending" class="bg-[#F7F9FC] rounded-lg p-4 border-2 border-gray-200 hover:border-blue-500 hover:shadow-lg transition-all duration-300 cursor-pointer block">
            <div class="flex items-center justify-between mb-3">
                <div class="w-10 h-10 bg-blue-500 rounded-lg flex items-center justify-center">
                    <i class="fas fa-user-check text-white"></i>
                </div>
                <span class="text-2xl font-bold text-blue-600">{{ $pendingTasks['review_requests'] ?? 0 }}</span>
            </div>
        ...
        <a href="{{ route('admin.submissions.index', ['status' => 'revision_required']) }}" class="bg-[#F7F9FC] rounded-lg p-4 border-2 border-gray-200 hover:border-orange-500 hover:shadow-lg transition-all duration-300 cursor-pointer block">
            <div class="flex items-center justify-between mb-3">
                <div class="w-10 h-10 bg-orange-500 rounded-lg flex items-center justify-center">
                    <i class="fas fa-edit text-white"></i>
                </div>
                <span class="text-2xl font-bold text-orange-600">{{ $pendingTasks['revision_submissions'] ?? 0 }}</span>
            </div>
        ...
        <!-- Decisions Required -->
        <a href="{{ route('admin.submissions.index', ['status' => 'submitted']) }}" class="bg-[#F7F9FC] rounded-lg p-4 border-2 border-gray-200 hover:border-purple-500 hover:shadow-lg transition-all duration-300 cursor-pointer block">
            <div class="flex items-center justify-between mb-3">
                <div class="w-10 h-10 bg-purple-500 rounded-lg flex items-center justify-center">
                    <i class="fas fa-gavel text-white"></i>
                </div>
                <span class="text-2xl font-bold text-purple-600">{{ $pendingTasks['decisions_required'] ?? 0 }}</span>
            </div>
    ...
    <div class="space-y-4">
        <div class="flex items-start space-x-4 p-4 bg-[#F7F9FC] rounded-lg">
            ...
            <div class="flex-1">
                <p class="text-sm text-gray-700">
                    <span class="font-semibold">{{ auth()->user()->full_name }}</span> created journal 
                    <span class="font-semibold">"Testing Shah"</span>
                </p>
                <p class="text-xs text-gray-500 mt-1">{{ now()->subDays(1)->format('M d, Y h:i A') }}</p>
            </div>
        </div>
        ...
        <div class="flex items-start space-x-4 p-4 bg-[#F7F9FC] rounded-lg">
            ...
            <div class="flex-1">
                ...
                <p class="text-xs text-gray-500 mt-1">{{ now()->subHours(5)->format('M d, Y h:i A') }}</p>
            </div>
        </div>
    </div>
</div>
