...
@section('title', 'Create New Journal - CISA')
@section('page-title', 'Create New Journal')
@section('page-subtitle', 'Initialize a new academic journal')
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div>
                                ...
                                <input type="text" name="journal_initials" value="{{ old('journal_initials') }}"
                            ...
                            <div>
                                ...
                                <input type="text" name="journal_abbreviation" value="{{ old('journal_abbreviation') }}"
                                    class="w-full px-4 py-3 bg-slate-50 border border-gray-200 rounded-lg">
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <input type="url" name="journal_url" value="{{ old('journal_url') }}"
                                    class="w-full px-4 py-3 bg-slate-50 border border-gray-200 rounded-lg">
                            </div>
                            <div>
                                ...
                                <input type="number" step="0.01" name="impact_factor"
                                    value="{{ old('impact_factor', '2.50') }}" placeholder="e.g. 2.50"
                                    class="w-full px-4 py-3 bg-slate-50 border border-gray-200 rounded-lg">
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <textarea name="homepage_content" id="homepage_content"
                                    class="hidden">{{ old('homepage_content') }}</textarea>
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-8">
                        ...
                        <div class="space-y-8">
                            <div>
                                ...
                                <textarea name="vision" id="vision" class="hidden">{{ old('vision') }}</textarea>
                            </div>
                            <div>
                                ...
                                <textarea name="mission" id="mission" class="hidden">{{ old('mission') }}</textarea>
                            </div>
                            <div>
                                ...
                                <textarea name="aims_scope" id="aims_scope"
                                    class="hidden">{{ old('aims_scope') }}</textarea>
                            </div>
                            <div>
                                ...
                                <textarea name="publication_frequency" id="publication_frequency"
                                    class="hidden">{{ old('publication_frequency') }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                            <div>
                                ...
                                <input type="text" name="print_issn" value="{{ old('print_issn') }}"
                            ...
                            <div>
                                ...
                                <input type="text" name="online_issn" value="{{ old('online_issn') }}"
                                    class="w-full px-4 py-3 bg-slate-50 border border-gray-200 rounded-lg font-mono">
                            </div>
                        </div>
                        <div class="space-y-8">
                            <div>
                                ...
                                <textarea name="peer_review_process" id="peer_review_process"
                                    class="hidden">{{ old('peer_review_process') }}</textarea>
                            </div>
                            <div>
                                ...
                                <textarea name="open_access_policy" id="open_access_policy"
                                    class="hidden">{{ old('open_access_policy') }}</textarea>
                            </div>
                            <div>
                                ...
                                <textarea name="copyright_notice" id="copyright_notice"
                                    class="hidden">{{ old('copyright_notice') }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="space-y-8">
                            <div>
                                ...
                                <textarea name="editor_in_chief" id="editor_in_chief"
                                    class="hidden">{{ old('editor_in_chief') }}</textarea>
                            </div>
                            <div>
                                ...
                                <textarea name="editorial_board_members" id="editorial_board_members"
                                    class="hidden">{{ old('editorial_board_members') }}</textarea>
                            </div>
                            <div>
                                ...
                                <textarea name="ethics_policy" id="ethics_policy"
                                    class="hidden">{{ old('ethics_policy') }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="space-y-8">
                            <div>
                                ...
                                <textarea name="apc_policy" id="apc_policy"
                                    class="hidden">{{ old('apc_policy') }}</textarea>
                            </div>
                            <div>
                                ...
                                <textarea name="submission_guidelines" id="submission_guidelines"
                                    class="hidden">{{ old('submission_guidelines') }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-8">
                        ...
                        <div>
                            ...
                            <textarea name="call_for_papers" id="call_for_papers"
                                class="hidden">{{ old('call_for_papers') }}</textarea>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea name="contact_address" rows="4"
                                    class="w-full px-4 py-3 bg-slate-50 border border-gray-200 rounded-lg">{{ old('contact_address') }}</textarea>
                            </div>
                        </div>
                    </div>
