...
@section('title', 'Edit Journal - ' . $journal->name . ' - EMANP')
@section('page-title', 'Edit Journal')
@section('page-subtitle', 'Update journal information and settings')
...
<div x-data="{ activeTab: 'basic' }">
    <form method="POST" action="{{ route('admin.journals.update', $journal) }}" enctype="multipart/form-data" id="journalForm">
        @csrf
        @method('PUT')
        ...
        <div class="space-y-6">
                ...
                <div class="bg-white rounded-xl border-2 border-gray-200 p-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="md:col-span-2">
                            ...
                            <input type="text" id="name" name="name" required value="{{ old('name', $journal->name) }}"
                        ...
                        <div>
                            ...
                            <input type="text" id="journal_initials" name="journal_initials" value="{{ old('journal_initials', $journal->journal_initials) }}"
                        ...
                        <div>
                            ...
                            <input type="text" id="journal_abbreviation" name="journal_abbreviation" value="{{ old('journal_abbreviation', $journal->journal_abbreviation) }}"
                        ...
                        <div>
                            ...
                            <input type="text" id="slug" name="slug" value="{{ old('slug', $journal->slug) }}"
                        ...
                        <div>
                            ...
                            <input type="text" id="journal_url" name="journal_url" value="{{ old('journal_url', $journal->journal_url) }}"
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input type="text" id="authors" name="authors" value="{{ old('authors', $journal->authors) }}"
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea id="description" name="description" data-initial-value="{{ old('description', $journal->description) }}" style="display:none;">{{ old('description', $journal->description) }}</textarea>
                            @error('description')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                ...
                <div class="bg-white rounded-xl border-2 border-gray-200 p-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" id="print_issn" name="print_issn" value="{{ old('print_issn', $journal->print_issn) }}"
                        ...
                        <div>
                            ...
                            <input type="text" id="online_issn" name="online_issn" value="{{ old('online_issn', $journal->online_issn) }}"
                                   placeholder="0000-0000"
                                   class="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:outline-none focus:border-[#0056FF] transition-colors text-gray-900"
                                   style="font-family: 'Inter', sans-serif; font-weight: 400;">
                            @error('online_issn')
                ...
                <div class="bg-white rounded-xl border-2 border-gray-200 p-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" id="primary_contact_name" name="primary_contact_name" value="{{ old('primary_contact_name', $journal->primary_contact_name) }}"
                        ...
                        <div>
                            ...
                            <input type="email" id="primary_contact_email" name="primary_contact_email" value="{{ old('primary_contact_email', $journal->primary_contact_email) }}"
                        ...
                        <div>
                            ...
                            <input type="text" id="contact_phone" name="contact_phone" value="{{ old('contact_phone', $journal->contact_phone) }}"
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea id="contact_address" name="contact_address" rows="3"
                                      ...
                                      style="font-family: 'Inter', sans-serif; font-weight: 400; line-height: 1.6;">{{ old('contact_address', $journal->contact_address) }}</textarea>
                        ...
                        <div>
                            ...
                            <input type="text" id="support_contact_name" name="support_contact_name" value="{{ old('support_contact_name', $journal->support_contact_name) }}"
                        ...
                        <div>
                            ...
                            <input type="email" id="support_email" name="support_email" value="{{ old('support_email', $journal->support_email) }}"
            ...
            <div x-show="activeTab === 'content'" class="space-y-6">
                ...
                <div class="bg-white rounded-xl border-2 border-gray-200 p-8">
                    ...
                    <div>
                        ...
                        <textarea id="focus_scope" name="focus_scope" style="display:none;">{{ old('focus_scope', $journal->focus_scope) }}</textarea>
                        @error('focus_scope')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="bg-white rounded-xl border-2 border-gray-200 p-8">
                    ...
                    <div>
                        ...
                        <textarea id="peer_review_policy" name="peer_review_policy" style="display:none;">{{ old('peer_review_policy', $journal->peer_review_policy) }}</textarea>
                ...
                <div class="bg-white rounded-xl border-2 border-gray-200 p-8">
                    ...
                    <div>
                        ...
                        <select id="publication_frequency" name="publication_frequency"
                            ...
                            <option value="monthly" {{ old('publication_frequency', $journal->publication_frequency) == 'monthly' ? 'selected' : '' }}>Monthly</option>
                            <option value="quarterly" {{ old('publication_frequency', $journal->publication_frequency) == 'quarterly' ? 'selected' : '' }}>Quarterly</option>
                            <option value="yearly" {{ old('publication_frequency', $journal->publication_frequency) == 'yearly' ? 'selected' : '' }}>Yearly</option>
                            <option value="bi-annual" {{ old('publication_frequency', $journal->publication_frequency) == 'bi-annual' ? 'selected' : '' }}>Bi-Annual</option>
                            <option value="continuous" {{ old('publication_frequency', $journal->publication_frequency) == 'continuous' ? 'selected' : '' }}>Continuous</option>
                        </select>
                ...
                <div class="bg-white rounded-xl border-2 border-gray-200 p-8">
                    ...
                    <div>
                        ...
                        <textarea id="open_access_policy" name="open_access_policy" style="display:none;">{{ old('open_access_policy', $journal->open_access_policy) }}</textarea>
                ...
                <div class="bg-white rounded-xl border-2 border-gray-200 p-8">
                    ...
                    <div>
                        ...
                        <textarea id="copyright_notice" name="copyright_notice" rows="4"
                                  class="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:outline-none focus:border-[#0056FF] transition-colors resize-none text-gray-900"
                                  style="font-family: 'Inter', sans-serif; font-weight: 400; line-height: 1.6;">{{ old('copyright_notice', $journal->copyright_notice) }}</textarea>
                ...
                <div class="bg-white rounded-xl border-2 border-gray-200 p-8">
                    ...
                    <div>
                        ...
                        <textarea id="privacy_statement" name="privacy_statement" style="display:none;">{{ old('privacy_statement', $journal->privacy_statement) }}</textarea>
                ...
                <div class="bg-white rounded-xl border-2 border-gray-200 p-8">
                    ...
                    <div class="space-y-6">
                        <div>
                            ...
                            <textarea id="editor_in_chief" name="editor_in_chief" style="display:none;">{{ old('editor_in_chief', $journal->editor_in_chief) }}</textarea>
                        ...
                        <div>
                            ...
                            <textarea id="managing_editor" name="managing_editor" style="display:none;">{{ old('managing_editor', $journal->managing_editor) }}</textarea>
                        ...
                        <div>
                            ...
                            <textarea id="section_editors" name="section_editors" style="display:none;">{{ old('section_editors', $journal->section_editors) }}</textarea>
                        ...
                        <div>
                            ...
                            <textarea id="editorial_board_members" name="editorial_board_members" style="display:none;">{{ old('editorial_board_members', $journal->editorial_board_members) }}</textarea>
            ...
            <div x-show="activeTab === 'guidelines'" class="space-y-6">
                <div class="bg-white rounded-xl border-2 border-gray-200 p-8">
                    ...
                    <div class="space-y-6">
                        <div>
                            <label for="submission_guidelines" class="block text-sm font-bold text-[#0F1B4C] mb-2" style="font-family: 'Inter', sans-serif; font-weight: 700;">
                                Submission Guidelines <span class="text-red-500">*</span>
                            </label>
                            <p class="text-xs text-gray-500 mb-2">This content will be displayed on the Submission Guidelines page</p>
                            <div id="submission_guidelines-editor" class="quill-editor"></div>
                            <textarea id="submission_guidelines" name="submission_guidelines" style="display:none;">{{ old('submission_guidelines', $journal->submission_guidelines) }}</textarea>
                        ...
                        <div>
                            ...
                            <textarea id="author_guidelines" name="author_guidelines" style="display:none;">{{ old('author_guidelines', $journal->author_guidelines) }}</textarea>
                        ...
                        <div>
                            ...
                            <textarea id="submission_requirements" name="submission_requirements" style="display:none;">{{ old('submission_requirements', $journal->submission_requirements) }}</textarea>
                        ...
                        <div>
                            ...
                            <textarea id="submission_checklist" name="submission_checklist" style="display:none;">{{ old('submission_checklist', $journal->submission_checklist) }}</textarea>
                        ...
                        <div>
                            ...
                            <textarea id="competing_interest_statement" name="competing_interest_statement" style="display:none;">{{ old('competing_interest_statement', $journal->competing_interest_statement) }}</textarea>
                        ...
                        <div>
                            ...
                            <textarea id="copyright_agreement" name="copyright_agreement" style="display:none;">{{ old('copyright_agreement', $journal->copyright_agreement) }}</textarea>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <select id="review_rounds" name="review_rounds"
                                    class="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:outline-none focus:border-[#0056FF] transition-colors text-gray-900"
                                    style="font-family: 'Inter', sans-serif; font-weight: 400;">
                                <option value="1" {{ old('review_rounds', $journal->review_rounds ?? 2) == 1 ? 'selected' : '' }}>1 Round</option>
                                <option value="2" {{ old('review_rounds', $journal->review_rounds ?? 2) == 2 ? 'selected' : '' }}>2 Rounds</option>
                                <option value="3" {{ old('review_rounds', $journal->review_rounds ?? 2) == 3 ? 'selected' : '' }}>3 Rounds</option>
                            </select>
                            @error('review_rounds')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        ...
                        <div>
                            ...
                            <select id="review_method" name="review_method"
                                ...
                                <option value="double_blind" {{ old('review_method', $journal->review_method) == 'double_blind' ? 'selected' : '' }}>Double Blind</option>
                                <option value="single_blind" {{ old('review_method', $journal->review_method) == 'single_blind' ? 'selected' : '' }}>Single Blind</option>
                                <option value="open" {{ old('review_method', $journal->review_method) == 'open' ? 'selected' : '' }}>Open Review</option>
                            </select>
                            @error('review_method')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                            ...
                            <div class="bg-blue-50 border-2 border-blue-200 rounded-lg p-4">
                                <label class="flex items-start cursor-pointer">
                                    <input type="checkbox" name="requires_review" value="1" 
                                           {{ old('requires_review', $journal->requires_review ?? true) ? 'checked' : '' }}
                                           class="mt-1 mr-3 w-5 h-5 text-[#0056FF] border-gray-300 rounded focus:ring-[#0056FF]">
                                    <div>
                                        <span class="block text-sm font-bold text-[#0F1B4C] mb-1">Require Review Process</span>
                                        <p class="text-xs text-gray-600">
                                            If enabled, all submissions must go through the review process. If disabled, admins can approve submissions directly without review.
                                        </p>
                                    </div>
                                </label>
                            </div>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea id="review_forms" name="review_forms" rows="4"
                                      ...
                                      class="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:outline-none focus:border-[#0056FF] transition-colors resize-none text-gray-900"
                                      style="font-family: 'Inter', sans-serif; font-weight: 400; line-height: 1.6;">{{ old('review_forms', $journal->review_forms) }}</textarea>
                            @error('review_forms')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        </div>
            ...
            <div x-show="activeTab === 'website'" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div class="border-2 border-dashed border-gray-300 rounded-lg p-6 hover:border-[#0056FF] transition-colors bg-[#F7F9FC]">
                                @if($journal->logo)
                                    <div class="mb-4 flex justify-center">
                                        <img src="{{ asset('storage/' . $journal->logo) }}" alt="Current logo" class="h-24 w-auto object-contain bg-white p-2 rounded-lg shadow-sm">
                                    </div>
                                @endif
                        ...
                        <div>
                            ...
                            <div class="border-2 border-dashed border-gray-300 rounded-lg p-6 hover:border-[#0056FF] transition-colors bg-[#F7F9FC]">
                                @if($journal->cover_image)
                                    <div class="mb-4 flex justify-center">
                                        <img src="{{ asset('storage/' . $journal->cover_image) }}" alt="Current cover" class="h-24 w-auto object-contain bg-white p-2 rounded-lg shadow-sm">
                                    </div>
                                @endif
                        ...
                        <div>
                            ...
                            <div class="border-2 border-dashed border-gray-300 rounded-lg p-6 hover:border-[#0056FF] transition-colors bg-[#F7F9FC]">
                                @if($journal->favicon)
                                    <div class="mb-4 flex justify-center">
                                        <img src="{{ asset('storage/' . $journal->favicon) }}" alt="Current favicon" class="h-16 w-16 object-contain bg-white p-2 rounded-lg shadow-sm">
                                    </div>
                                @endif
                ...
                <div class="bg-white rounded-xl border-2 border-gray-200 p-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <select id="theme" name="theme"
                                    class="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:outline-none focus:border-[#0056FF] transition-colors text-gray-900"
                                    style="font-family: 'Inter', sans-serif; font-weight: 400;">
                                <option value="default" {{ old('theme', $journal->theme ?? 'default') == 'default' ? 'selected' : '' }}>Default</option>
                                <option value="modern" {{ old('theme', $journal->theme) == 'modern' ? 'selected' : '' }}>Modern</option>
                                <option value="classic" {{ old('theme', $journal->theme) == 'classic' ? 'selected' : '' }}>Classic</option>
                                <option value="minimal" {{ old('theme', $journal->theme) == 'minimal' ? 'selected' : '' }}>Minimal</option>
                            </select>
                            @error('theme')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                    ...
                    <div class="mt-6">
                        ...
                        <textarea id="homepage_content" name="homepage_content" style="display:none;">{{ old('homepage_content', $journal->homepage_content) }}</textarea>
                    ...
                    <div class="mt-6">
                        ...
                        <textarea id="footer_content" name="footer_content" rows="3"
                                  ...
                                  class="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:outline-none focus:border-[#0056FF] transition-colors resize-none text-gray-900"
                                  style="font-family: 'Inter', sans-serif; font-weight: 400; line-height: 1.6;">{{ old('footer_content', $journal->footer_content) }}</textarea>
                ...
                <div class="bg-white rounded-xl border-2 border-gray-200 p-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" id="doi_prefix" name="doi_prefix" value="{{ old('doi_prefix', $journal->doi_prefix) }}"
                        ...
                        <div class="flex items-center">
                            <label class="flex items-center space-x-3 cursor-pointer">
                                <input type="checkbox" name="doi_enabled" value="1" {{ old('doi_enabled', $journal->doi_enabled) ? 'checked' : '' }}
                ...
                <div class="bg-white rounded-xl border-2 border-gray-200 p-8">
                    ...
                    <div>
                        ...
                        <select id="license_type" name="license_type"
                            ...
                            <option value="CC BY" {{ old('license_type', $journal->license_type) == 'CC BY' ? 'selected' : '' }}>CC BY (Creative Commons Attribution)</option>
                            <option value="CC BY-NC" {{ old('license_type', $journal->license_type) == 'CC BY-NC' ? 'selected' : '' }}>CC BY-NC (Attribution-NonCommercial)</option>
                            <option value="CC BY-SA" {{ old('license_type', $journal->license_type) == 'CC BY-SA' ? 'selected' : '' }}>CC BY-SA (Attribution-ShareAlike)</option>
                            <option value="CC BY-ND" {{ old('license_type', $journal->license_type) == 'CC BY-ND' ? 'selected' : '' }}>CC BY-ND (Attribution-NoDerivs)</option>
                            <option value="All Rights Reserved" {{ old('license_type', $journal->license_type) == 'All Rights Reserved' ? 'selected' : '' }}>All Rights Reserved</option>
                        </select>
                        @error('license_type')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div>
                            ...
                            <select id="primary_language" name="primary_language"
                                    class="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:outline-none focus:border-[#0056FF] transition-colors text-gray-900"
                                    style="font-family: 'Inter', sans-serif; font-weight: 400;">
                                <option value="en" {{ old('primary_language', $journal->primary_language ?? 'en') == 'en' ? 'selected' : '' }}>English</option>
                                <option value="es" {{ old('primary_language', $journal->primary_language) == 'es' ? 'selected' : '' }}>Spanish</option>
                                <option value="fr" {{ old('primary_language', $journal->primary_language) == 'fr' ? 'selected' : '' }}>French</option>
                                <option value="de" {{ old('primary_language', $journal->primary_language) == 'de' ? 'selected' : '' }}>German</option>
                                <option value="ar" {{ old('primary_language', $journal->primary_language) == 'ar' ? 'selected' : '' }}>Arabic</option>
                                <option value="ur" {{ old('primary_language', $journal->primary_language) == 'ur' ? 'selected' : '' }}>Urdu</option>
                            </select>
                        ...
                        <div>
                            ...
                            <select id="timezone" name="timezone"
                                    class="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:outline-none focus:border-[#0056FF] transition-colors text-gray-900"
                                    style="font-family: 'Inter', sans-serif; font-weight: 400;">
                                <option value="UTC" {{ old('timezone', $journal->timezone ?? 'UTC') == 'UTC' ? 'selected' : '' }}>UTC</option>
                                <option value="America/New_York" {{ old('timezone', $journal->timezone) == 'America/New_York' ? 'selected' : '' }}>America/New_York</option>
                                <option value="Europe/London" {{ old('timezone', $journal->timezone) == 'Europe/London' ? 'selected' : '' }}>Europe/London</option>
                                <option value="Asia/Karachi" {{ old('timezone', $journal->timezone) == 'Asia/Karachi' ? 'selected' : '' }}>Asia/Karachi</option>
                            </select>
                            @error('timezone')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        ...
                        <div>
                            ...
                            <select id="date_format" name="date_format"
                                    class="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:outline-none focus:border-[#0056FF] transition-colors text-gray-900"
                                    style="font-family: 'Inter', sans-serif; font-weight: 400;">
                                <option value="Y-m-d" {{ old('date_format', $journal->date_format ?? 'Y-m-d') == 'Y-m-d' ? 'selected' : '' }}>YYYY-MM-DD</option>
                                <option value="d/m/Y" {{ old('date_format', $journal->date_format) == 'd/m/Y' ? 'selected' : '' }}>DD/MM/YYYY</option>
                                <option value="m/d/Y" {{ old('date_format', $journal->date_format) == 'm/d/Y' ? 'selected' : '' }}>MM/DD/YYYY</option>
                            </select>
                            @error('date_format')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                ...
                <div class="bg-white rounded-xl border-2 border-gray-200 p-8">
                    ...
                    <div>
                        <label class="flex items-center cursor-pointer">
                            ...
                            <div class="relative w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-[#0056FF]"></div>
                            <span class="ml-3 text-sm font-medium text-gray-900">Journal is Active</span>
                        </label>
                        @error('is_active')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                ...
                <div class="bg-white rounded-xl border-2 border-gray-200 p-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="number" id="max_file_size" name="max_file_size" value="{{ old('max_file_size', $journal->max_file_size ?? 10) }}"
                                   min="1" max="100"
                                   class="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:outline-none focus:border-[#0056FF] transition-colors text-gray-900"
                                   style="font-family: 'Inter', sans-serif; font-weight: 400;">
                            @error('max_file_size')
                        ...
                        <div class="flex items-center">
                            <label class="flex items-center space-x-3 cursor-pointer">
                                <input type="checkbox" name="plagiarism_check_required" value="1" {{ old('plagiarism_check_required', $journal->plagiarism_check_required) ? 'checked' : '' }}
                                       class="w-5 h-5 text-[#0056FF] border-gray-300 rounded focus:ring-[#0056FF] cursor-pointer">
                                <span class="text-sm font-bold text-[#0F1B4C]" style="font-family: 'Inter', sans-serif; font-weight: 700;">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <div class="flex flex-wrap gap-4">
                                @php
                                    // Handle old input first (from validation errors)
                                    $allowedFormats = old('allowed_formats');
                                    
                                    // If no old input, get from journal and decode JSON
                                    if (empty($allowedFormats)) {
                                        $allowedFormats = $journal->allowed_formats;
                                        // If it's a JSON string, decode it
                                        if (is_string($allowedFormats)) {
                                            $allowedFormats = json_decode($allowedFormats, true) ?? [];
                                        }
                                        // If still empty or null, set default
                                        if (empty($allowedFormats)) {
                                            $allowedFormats = ['pdf'];
                                        }
                                    }
                                ...
                                <label class="flex items-center space-x-2 cursor-pointer">
                                    <input type="checkbox" name="allowed_formats[]" value="pdf" {{ in_array('pdf', $allowedFormats) ? 'checked' : '' }}
                                ...
                                <label class="flex items-center space-x-2 cursor-pointer">
                                    <input type="checkbox" name="allowed_formats[]" value="docx" {{ in_array('docx', $allowedFormats) ? 'checked' : '' }}
                                           class="w-4 h-4 text-[#0056FF] border-gray-300 rounded focus:ring-[#0056FF] cursor-pointer">
                                    <span class="text-sm text-gray-700">DOCX</span>
                                </label>
                                <label class="flex items-center space-x-2 cursor-pointer">
                                    <input type="checkbox" name="allowed_formats[]" value="doc" {{ in_array('doc', $allowedFormats) ? 'checked' : '' }}
                                           class="w-4 h-4 text-[#0056FF] border-gray-300 rounded focus:ring-[#0056FF] cursor-pointer">
            ...
            <div class="bg-white rounded-xl border-2 border-gray-200 p-6 mb-6">
                <h3 class="text-lg font-bold text-[#0F1B4C] mb-4">
                    <i class="fas fa-bolt mr-2 text-[#0056FF]"></i>Quick Actions
                </h3>
                <div class="flex flex-wrap gap-3">
                    <a href="{{ route('admin.sections.index', $journal) }}" 
                       class="px-6 py-3 bg-purple-100 hover:bg-purple-200 text-purple-700 rounded-lg font-semibold transition-colors">
                        <i class="fas fa-folder-open mr-2"></i>Manage Sections
                    </a>
                    <a href="{{ route('admin.journal-pages.index') }}?journal={{ $journal->id }}" 
                       class="px-6 py-3 bg-blue-100 hover:bg-blue-200 text-blue-700 rounded-lg font-semibold transition-colors">
                        <i class="fas fa-file-alt mr-2"></i>Journal Pages
                    </a>
                    <a href="{{ route('journals.show', $journal->slug) }}" 
                       target="_blank"
                       class="px-6 py-3 bg-green-100 hover:bg-green-200 text-green-700 rounded-lg font-semibold transition-colors">
...
<script>
    ...
    editorFields.forEach(field => {
        ...
        if (textarea) {
            ...
            if (content.trim()) {
                editors[field].root.innerHTML = content;
            }
        }
