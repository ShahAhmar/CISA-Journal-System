...
@section('title', 'Edit Journal - CISA')
@section('page-title', 'Edit Journal')
@section('page-subtitle', 'Update journal settings: ' . $journal->name)
    ...
    <div x-data="{ activeTab: 'basic' }">
            ...
            <div class="space-y-6 pb-20">
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div class="md:col-span-2">
                                ...
                                <input type="text" name="name" value="{{ old('name', $journal->name) }}" required
                            ...
                            <div>
                                ...
                                <input type="text" name="journal_initials"
                                    value="{{ old('journal_initials', $journal->journal_initials) }}"
                            ...
                            <div>
                                ...
                                <input type="text" name="journal_abbreviation"
                                    value="{{ old('journal_abbreviation', $journal->journal_abbreviation) }}"
                                    class="w-full px-4 py-3 bg-slate-50 border border-gray-200 rounded-lg">
                            </div>
                            <div>
                                <label class="block text-sm font-bold text-cisa-base mb-2">URL Slug</label>
                                <input type="text" name="slug" value="{{ old('slug', $journal->slug) }}"
                            ...
                            <div>
                                ...
                                <input type="url" name="journal_url" value="{{ old('journal_url', $journal->journal_url) }}"
                                    class="w-full px-4 py-3 bg-slate-50 border border-gray-200 rounded-lg">
                            </div>
                            <div>
                                ...
                                <input type="number" step="0.01" name="impact_factor"
                                    value="{{ old('impact_factor', $journal->impact_factor) }}" placeholder="e.g. 2.50"
                                    class="w-full px-4 py-3 bg-slate-50 border border-gray-200 rounded-lg">
                            ...
                            <div class="md:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-8 pt-4">
                                <div class="p-6 border-2 border-dashed border-gray-200 rounded-xl text-center">
                                    ...
                                    @if($journal->logo) <img src="{{ Storage::url($journal->logo) }}"
                                    class="h-16 mx-auto mb-4"> @endif
                                ...
                                <div class="p-6 border-2 border-dashed border-gray-200 rounded-xl text-center">
                                    ...
                                    @if($journal->cover_image) <img src="{{ Storage::url($journal->cover_image) }}"
                                    class="h-32 mx-auto mb-4 object-cover"> @endif
                ...
                <div x-show="activeTab === 'pages'" class="space-y-6" x-cloak>
                    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-8">
                        ...
                        <div class="space-y-4">
                            @foreach($journal->pageSettings->sortBy('display_order') as $setting)
                                <div class="flex items-center gap-4 p-4 border border-gray-100 rounded-lg bg-slate-50">
                                    <span
                                        class="bg-white px-2 py-1 rounded text-xs font-mono font-bold text-gray-400 w-12 text-center">{{ $setting->page_key }}</span>
                                    <div class="flex-grow grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div>
                                            <label class="text-xs font-bold text-gray-500 block mb-1">Page Title (H1)</label>
                                            <input type="text" name="page_settings[{{ $setting->id }}][page_title]"
                                                value="{{ $setting->page_title }}"
                                                class="w-full px-3 py-2 border rounded text-sm">
                                        </div>
                                        <div>
                                            <label class="text-xs font-bold text-gray-500 block mb-1">Menu Label</label>
                                            <input type="text" name="page_settings[{{ $setting->id }}][menu_label]"
                                                value="{{ $setting->menu_label }}"
                                                class="w-full px-3 py-2 border rounded text-sm">
                                        </div>
                                    </div>
                                    <div class="flex items-center gap-2">
                                        <input type="hidden" name="page_settings[{{ $setting->id }}][is_enabled]" value="0">
                                        <input type="checkbox" name="page_settings[{{ $setting->id }}][is_enabled]" value="1" {{ $setting->is_enabled ? 'checked' : '' }} class="w-5 h-5 text-cisa-accent rounded">
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-8">
                        ...
                        <div class="space-y-6">
                            <div>
                                ...
                                <input type="text" name="badge_text" value="{{ old('badge_text', $journal->badge_text) }}"
                            ...
                            <div>
                                ...
                                <textarea name="description" id="description"
                                    class="hidden">{{ old('description', $journal->description) }}</textarea>
                            </div>
                            <div>
                                ...
                                <textarea name="homepage_content" id="homepage_content"
                                    class="hidden">{{ old('homepage_content', $journal->homepage_content) }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="space-y-8">
                            <div>
                                ...
                                <textarea name="vision" id="vision"
                                    class="hidden">{{ old('vision', $journal->vision) }}</textarea>
                            </div>
                            <div>
                                ...
                                <textarea name="mission" id="mission"
                                    class="hidden">{{ old('mission', $journal->mission) }}</textarea>
                            </div>
                            <div>
                                ...
                                <textarea name="aims_scope" id="aims_scope"
                                    class="hidden">{{ old('aims_scope', $journal->aims_scope) }}</textarea>
                            </div>
                            <div>
                                ...
                                <textarea name="publication_frequency" id="publication_frequency"
                                    class="hidden">{{ old('publication_frequency', $journal->publication_frequency) }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                            <div>
                                ...
                                <input type="text" name="print_issn" value="{{ old('print_issn', $journal->print_issn) }}"
                            ...
                            <div>
                                ...
                                <input type="text" name="online_issn"
                                    value="{{ old('online_issn', $journal->online_issn) }}"
                                    class="w-full px-4 py-3 bg-slate-50 border border-gray-200 rounded-lg font-mono">
                            </div>
                        </div>
                        <div class="space-y-8">
                            <div>
                                ...
                                <textarea name="peer_review_process" id="peer_review_process"
                                    class="hidden">{{ old('peer_review_process', $journal->peer_review_process) }}</textarea>
                            </div>
                            <div>
                                ...
                                <textarea name="open_access_policy" id="open_access_policy"
                                    class="hidden">{{ old('open_access_policy', $journal->open_access_policy) }}</textarea>
                            </div>
                            <div>
                                ...
                                <textarea name="copyright_notice" id="copyright_notice"
                                    class="hidden">{{ old('copyright_notice', $journal->copyright_notice) }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="space-y-8">
                            <div>
                                ...
                                <textarea name="editor_in_chief" id="editor_in_chief"
                                    class="hidden">{{ old('editor_in_chief', $journal->editor_in_chief) }}</textarea>
                            </div>
                            <div>
                                ...
                                <textarea name="editorial_board_members" id="editorial_board_members"
                                    class="hidden">{{ old('editorial_board_members', $journal->editorial_board_members) }}</textarea>
                            </div>
                            <div>
                                ...
                                <textarea name="ethics_policy" id="ethics_policy"
                                    class="hidden">{{ old('ethics_policy', $journal->ethics_policy) }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="space-y-8">
                            <div>
                                ...
                                <textarea name="apc_policy" id="apc_policy"
                                    class="hidden">{{ old('apc_policy', $journal->apc_policy) }}</textarea>
                            </div>
                            <div>
                                ...
                                <textarea name="submission_guidelines" id="submission_guidelines"
                                    class="hidden">{{ old('submission_guidelines', $journal->submission_guidelines) }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-8">
                        ...
                        <div>
                            ...
                            <textarea name="call_for_papers" id="call_for_papers"
                                class="hidden">{{ old('call_for_papers', $journal->call_for_papers) }}</textarea>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-8">
                        ...
                        <div>
                            ...
                            <textarea name="partnerships_content" id="partnerships_content"
                                class="hidden">{{ old('partnerships_content', $journal->partnerships_content) }}</textarea>
                        </div>
                    </div>

                    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-8"
                        x-data="{ partners: {{ $journal->partners->count() > 0 ? $journal->partners->map(function ($p) {
        return ['id' => $p->id, 'name' => $p->name, 'website_url' => $p->website_url, 'logo_url' => asset('storage/' . $p->logo)]; })->toJson() : '[]' }} }">
                ...
                <div x-show="activeTab === 'disciplines'" class="space-y-6"
                    x-data="{ items: {{ $journal->disciplines->count() > 0 ? $journal->disciplines->toJson() : '[]' }} }"
                    x-cloak>
                    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-8">
                        <div class="flex items-center justify-between mb-6 border-b pb-2">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div>
                                ...
                                <input type="text" name="primary_contact_name"
                                    value="{{ old('primary_contact_name', $journal->primary_contact_name) }}"
                                    class="w-full px-4 py-3 bg-slate-50 border border-gray-200 rounded-lg">
                            </div>
                            <div>
                                ...
                                <input type="email" name="primary_contact_email"
                                    value="{{ old('primary_contact_email', $journal->primary_contact_email) }}"
                                    class="w-full px-4 py-3 bg-slate-50 border border-gray-200 rounded-lg">
                            </div>
                            <div class="md:col-span-2">
                                <label class="block text-sm font-bold text-cisa-base mb-2">Mailing Address</label>
                                <textarea name="contact_address" rows="4"
                                    class="w-full px-4 py-3 bg-slate-50 border border-gray-200 rounded-lg">{{ old('contact_address', $journal->contact_address) }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
