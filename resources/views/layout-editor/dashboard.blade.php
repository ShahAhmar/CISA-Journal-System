...
@section('title', 'Layout Editor Dashboard - EMANP')
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-bold text-[#0F1B4C]">
                        <i class="fas fa-paint-brush mr-3 text-[#0056FF]"></i>Layout Editor Dashboard
                    </h1>
                    <p class="text-gray-600 mt-2">Manage layout editing tasks for assigned submissions</p>
                </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
            <div class="bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl shadow-lg p-6 text-white">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-blue-100 text-sm font-semibold">Pending (Proofreading)</p>
            ...
            <div class="bg-gradient-to-br from-green-500 to-green-600 rounded-xl shadow-lg p-6 text-white">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-green-100 text-sm font-semibold">In Layout</p>
                        <p class="text-3xl font-bold mt-2">{{ $stats['in_layout'] ?? 0 }}</p>
                    </div>
                    <i class="fas fa-paint-brush text-4xl opacity-50"></i>
                </div>
            </div>
            ...
            <div class="bg-gradient-to-br from-purple-500 to-purple-600 rounded-xl shadow-lg p-6 text-white">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-purple-100 text-sm font-semibold">Total Assigned</p>
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gradient-to-r from-[#0056FF] to-[#1D72B8]">
                        <tr>
                            ...
                            <th class="px-6 py-4 text-left text-xs font-bold text-white uppercase">Stage</th>
                            <th class="px-6 py-4 text-left text-xs font-bold text-white uppercase">Galleys</th>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-blue-50 transition-colors">
                            ...
                            <td class="px-6 py-4">
                                <span class="px-3 py-1 rounded-full text-xs font-semibold
                                    {{ $submission->current_stage === 'layout' ? 'bg-green-100 text-green-800' : 'bg-blue-100 text-blue-800' }}">
                                    {{ ucfirst(str_replace('_', ' ', $submission->current_stage)) }}
                                </span>
                            </td>
                            <td class="px-6 py-4 text-sm text-gray-700">
                                {{ $submission->galleys->count() }} file(s)
                            </td>
                        ...
                        <tr>
                            <td colspan="6" class="px-6 py-12 text-center">
                                ...
                                <p class="text-gray-400">You'll see layout editing tasks here when assigned</p>
                            </td>
                        </tr>
                        @endforelse
                    </tbody>
