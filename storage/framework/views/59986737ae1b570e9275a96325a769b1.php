...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'CISA Interdisciplinary Journal (CIJ)'); ?></title>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-20">
                ...
                <div class="flex-shrink-0 flex items-center">
                    <a href="<?php echo e(route('journals.index')); ?>" class="flex items-center space-x-3 group">
                        <?php if(isset($siteSettings) && $siteSettings->logo): ?>
                            <img src="<?php echo e(asset($siteSettings->logo)); ?>" alt="<?php echo e($siteSettings->homepage_title); ?>"
                ...
                <div
                    ...
                    <?php if($navJournal): ?>
                        <a href="<?php echo e(route('journals.show', $navJournal)); ?>"
                            class="hover:text-cisa-accent whitespace-nowrap transition-colors relative group <?php echo e(request()->routeIs('journals.show') ? 'text-cisa-base' : ''); ?>">
                            Home
                            <span
                                class="absolute -bottom-1 left-0 w-0 h-0.5 bg-cisa-accent transition-all group-hover:w-full"></span>
                        </a>

                        <?php if($navJournal->pageSettings->count() > 0): ?>
                            <?php $__currentLoopData = $navJournal->pageSettings->where('is_enabled', true)->sortBy('display_order'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php
                                    $routeMap = [
                                ...
                                <?php if($routeName): ?>
                                    ...
                                    <?php if(!$skipPage): ?>
                                        <a href="<?php echo e(route($routeName, $navJournal)); ?>"
                                            class="hover:text-cisa-accent whitespace-nowrap transition-colors relative group <?php echo e(request()->routeIs($routeName) ? 'text-cisa-base' : ''); ?>">
                                            <?php echo e($page->menu_label); ?>
                        ...
                        <?php else: ?>
                            ...
                            <a href="<?php echo e(route('journals.about', $navJournal)); ?>"
                    ...
                    <?php else: ?>
                        ...
                        <a href="<?php echo e(route('journals.index')); ?>"
                            class="hover:text-cisa-accent whitespace-nowrap transition-colors relative group <?php echo e(request()->routeIs('journals.index') ? 'text-cisa-base' : ''); ?>">
                            Portal Home
                            <span
                                class="absolute -bottom-1 left-0 w-0 h-0.5 bg-cisa-accent transition-all group-hover:w-full"></span>
                        </a>
                        <a href="<?php echo e(route('publish.index')); ?>"
                    ...
                    <?php if(auth()->guard()->check()): ?>
                        ...
                        <div class="relative ml-4" x-data="{ open: false }">
                            ...
                            <div x-show="open" @click.away="open = false" x-cloak style="display: none;"
                                ...
                                <a href="<?php echo e(route('author.payments.index')); ?>"
                    ...
                    <?php else: ?>
                        <div class="flex items-center gap-4 ml-4">
                            ...
                            <a href="<?php echo e($navJournal ? route('author.submissions.create', $navJournal) : route('register')); ?>"
                            ...
                            <?php if(auth()->guard()->check()): ?>
                                <div class="flex items-center space-x-3 py-2 mb-2">
                                    ...
                                    <div class="flex-1 overflow-hidden">
                                        <p class="font-bold text-gray-900 truncate"><?php echo e(auth()->user()->name); ?></p>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
                ...
                <div class="space-y-4">
                    <div class="flex items-center space-x-3">
                        <?php if(isset($siteSettings) && $siteSettings->logo): ?>
                            <img src="<?php echo e(asset($siteSettings->logo)); ?>" alt="Logo"
                    ...
                    <p class="text-cisa-muted text-sm leading-relaxed">
                        <?php echo e($siteSettings->footer_description ?? 'Excellence in Management & Academic Network Publishing. Advancing global knowledge through open-access research.'); ?>

                    </p>
                    <div class="pt-4">
                        <?php if(!empty($siteSettings->support_button_text) && !empty($siteSettings->support_button_url)): ?>
                            <a href="<?php echo e($siteSettings->support_button_url); ?>"
                                ...
                                <?php echo e($siteSettings->support_button_text); ?>

                            </a>
                        <?php endif; ?>
                    </div>
                    <div class="flex space-x-4 pt-2">
                        <?php if(isset($siteSettings) && $siteSettings->twitter_url): ?>
                            <a href="<?php echo e($siteSettings->twitter_url); ?>" target="_blank"
                                class="text-gray-400 hover:text-cisa-accent transition-colors"><i
                                    class="fab fa-twitter text-lg"></i></a>
                        <?php endif; ?>
                        <?php if(isset($siteSettings) && $siteSettings->linkedin_url): ?>
                            <a href="<?php echo e($siteSettings->linkedin_url); ?>" target="_blank"
                                class="text-gray-400 hover:text-cisa-accent transition-colors"><i
                                    class="fab fa-linkedin text-lg"></i></a>
                        <?php endif; ?>
                        <?php if(isset($siteSettings) && $siteSettings->facebook_url): ?>
                            <a href="<?php echo e($siteSettings->facebook_url); ?>" target="_blank"
                                class="text-gray-400 hover:text-cisa-accent transition-colors"><i
                                    class="fab fa-facebook text-lg"></i></a>
                        <?php endif; ?>
                        <?php if(isset($siteSettings) && $siteSettings->instagram_url): ?>
                            <a href="<?php echo e($siteSettings->instagram_url); ?>" target="_blank"
                                class="text-gray-400 hover:text-cisa-accent transition-colors"><i
                ...
                <div>
                    <h4 class="text-lg font-serif font-bold mb-6 text-cisa-accent">
                        <?php echo e($siteSettings->footer_section_1_title ?? 'Resources'); ?>
                    ...
                    <ul class="space-y-3 text-sm text-gray-300">
                        ...
                        <li><a href="<?php echo e(isset($navJournal) ? route('journals.call-for-papers', $navJournal) : route('login')); ?>"
                                class="hover:text-white transition-colors flex items-center"><i
                ...
                <div>
                    <h4 class="text-lg font-serif font-bold mb-6 text-cisa-accent">
                        <?php echo e($siteSettings->footer_section_2_title ?? 'Journals'); ?>

                    </h4>
                    <ul class="space-y-3 text-sm text-gray-300">
                        <li><a href="<?php echo e(route('journals.index')); ?>"
                                class="hover:text-white transition-colors flex items-center"><i
                                    class="fas fa-chevron-right text-cisa-accent text-[10px] mr-2"></i>Browse All</a>
                        </li>
                        <li><a href="<?php echo e(isset($navJournal) ? route('journals.about', $navJournal) : '#'); ?>"
                                class="hover:text-white transition-colors flex items-center"><i
                                    class="fas fa-chevron-right text-cisa-accent text-[10px] mr-2"></i>Open Access
                                Policy</a></li>
                        <li><a href="<?php echo e(isset($navJournal) ? route('journals.editorial-ethics', $navJournal) : '#'); ?>"
                                class="hover:text-white transition-colors flex items-center"><i
                ...
                <div>
                    <h4 class="text-lg font-serif font-bold mb-6 text-cisa-accent">
                        <?php echo e($siteSettings->footer_section_3_title ?? 'Contact'); ?>

                    </h4>
                    <ul class="space-y-3 text-sm text-gray-300">
                        <li class="flex items-start">
                            <i class="fas fa-map-marker-alt mt-1 mr-3 text-cisa-accent"></i>
                            <span><?php echo e($siteSettings->contact_address ?? '123 Academic Way, Research City, RC 10010'); ?></span>
                        </li>
                        <li class="flex items-center">
                            <i class="fas fa-envelope mr-3 text-cisa-accent"></i>
                            <span><?php echo e($siteSettings->contact_email ?? 'editor@cisajournal.com'); ?></span>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div
                ...
                <div class="mb-4 md:mb-0">
                    <p><?php echo $siteSettings->footer_text ?? '&copy; ' . date('Y') . ' CISA Interdisciplinary Journal. All rights reserved.'; ?>
...
</html><?php /**PATH /home/u857061584/domains/cisajournal.org/public_html/resources/views/layouts/app.blade.php ENDPATH**/ ?>