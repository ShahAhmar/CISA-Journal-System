...
<?php $__env->startSection('title', 'My Payments - CISA'); ?>
            ...
            <div
                ...
                <div class="flex items-center gap-3">
                    <div class="flex flex-col items-end">
                        ...
                        <span
                            class="text-sm font-black text-green-600"><?php echo e($payments->where('status', 'completed')->count()); ?>
                    ...
                    <div class="flex flex-col items-end">
                        ...
                        <span
                            class="text-sm font-black text-blue-600"><?php echo e($payments->where('status', 'processing')->count()); ?>
                            ...
                            <tr class="hover:bg-slate-50/80 transition-all">
                                <td class="px-6 py-6">
                                    <div class="flex flex-col">
                                        <span
                                            class="text-sm font-black text-cisa-base uppercase">#INV-<?php echo e(str_pad($payment->id, 5, '0', STR_PAD_LEFT)); ?></span>
                                        <span
                                            class="text-xs text-slate-500 font-bold mt-1 line-clamp-1 italic"><?php echo e($payment->submission->title ?? 'N/A'); ?></span>
                                    </div>
                                </td>
                                ...
                                <td class="px-6 py-6">
                                    ...
                                    ?>
                                    <span
                                        class="px-4 py-1.5 rounded-full border-2 <?php echo e($class); ?> text-[10px] font-black uppercase tracking-widest">
                                        <?php echo e(strtoupper($payment->status)); ?>

                                    </span>
                                </td>
                                <td class="px-6 py-6 text-right">
                                    <a href="<?php echo e(route('author.payments.show', $payment)); ?>"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u857061584/domains/cisajournal.org/public_html/resources/views/author/payments/index.blade.php ENDPATH**/ ?>