...
<?php $__env->startSection('title', 'Dashboard | CISA'); ?>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div
                    ...
                    <div class="flex items-center justify-between mb-4">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-cisa-base mt-1"><?php echo e($userJournals->count()); ?></p>
                        </div>
                        <div
                ...
                <div
                    ...
                    <div class="flex items-center justify-between mb-4">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-cisa-base mt-1"><?php echo e($submissions->count()); ?></p>
                        </div>
                        <div
                    ...
                    <a href="<?php echo e(route('author.submissions.index')); ?>"
                        class="text-sm font-bold text-cisa-accent hover:text-cisa-base transition-colors flex items-center">
                    ...
                    <div class="flex items-center justify-between mb-4">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-cisa-base mt-1">
                                <?php echo e($submissions->where('status', 'published')->count()); ?></p>
                        </div>
                        <div
            ...
            <?php if($userJournals->count() > 0): ?>
                <div class="mb-10">
                    <div class="flex items-center justify-between mb-6">
                        ...
                        <a href="<?php echo e(route('journals.index')); ?>" class="btn-cisa-outline py-1 px-4 text-xs">View All</a>
                    </div>
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        <?php $__currentLoopData = $userJournals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $journal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div
                                ...
                                <div class="flex justify-between items-start mb-4">
                                    <div
                                        ...
                                        <?php echo e(ucfirst(str_replace('_', ' ', $journal->pivot->role))); ?>
                                ...
                                <p class="text-sm text-gray-500 mb-6 line-clamp-2 min-h-[2.5rem]">
                                    <?php echo e($journal->description ?? 'No description available'); ?>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                <div class="p-6 border-b border-gray-100 flex items-center justify-between">
                    ...
                    <a href="<?php echo e(route('author.submissions.index')); ?>" class="btn-cisa-primary py-2 px-4 text-xs">
                                    ...
                                    <tr class="hover:bg-slate-50/50 transition-colors">
                                        <td class="px-6 py-4">
                                            <div class="font-bold text-gray-800 text-sm mb-1 line-clamp-1"
                                                title="<?php echo e($submission->title); ?>">
                                                <?php echo e(Str::limit($submission->title, 60)); ?>

                                            </div>
                                            <span class="text-xs text-gray-400 font-mono">ID: #<?php echo e($submission->id); ?></span>
                                        </td>
                                        <td class="px-6 py-4">
                                            <div class="text-sm text-gray-600"><?php echo e(Str::limit($submission->journal->name, 30)); ?>
                                        ...
                                        <td class="px-6 py-4">
                                            ...
                                            ?>
                                            <span class="px-3 py-1 rounded-full text-xs font-bold <?php echo e($cls); ?>">
                                                <?php echo e($label); ?>

                                            </span>
                                        </td>
                                        <td class="px-6 py-4 text-sm text-gray-500">
                                            <?php echo e(\Carbon\Carbon::parse($submission->submitted_at ?? $submission->created_at)->format('M d, Y')); ?>
                ...
                <?php else: ?>
                    <div class="p-12 text-center">
                        ...
                        <a href="<?php echo e(route('journals.index')); ?>" class="btn-cisa-accent">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u857061584/domains/cisajournal.org/public_html/resources/views/dashboard.blade.php ENDPATH**/ ?>