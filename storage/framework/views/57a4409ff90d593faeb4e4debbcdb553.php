...
<?php $__env->startSection('title', $journal->name . ' - CISA'); ?>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                <div class="lg:col-span-9 space-y-4">
                    ...
                    <p class="text-base md:text-lg text-gray-200 leading-relaxed max-w-2xl font-light">
                        <?php echo e($journal->description_excerpt ?? 'Promoting interdisciplinary research excellence and academic innovation through rigorous peer-reviewed publications.'); ?>
                    ...
                    <div class="flex flex-wrap gap-3 mt-8">
                        <span
                            ...
                            <?php echo e($journal->badge_text ?? 'Peer Reviewed & Open Access'); ?>
                        ...
                        <?php if($journal->online_issn): ?>
                            <span
                                ...
                                ISSN: <?php echo e($journal->online_issn); ?>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    <div>
                        ...
                        <div class="prose prose-lg text-gray-600 leading-relaxed mb-6">
                            <?php echo Str::limit($journal->description, 400); ?>
                    ...
                    <?php if($journal->call_for_papers): ?>
                        <div class="bg-slate-50 rounded-3xl p-8 border border-slate-100 relative overflow-hidden shadow-md">
                            ...
                            <div class="text-gray-600 mb-6 line-clamp-3">
                                <?php echo strip_tags($journal->call_for_papers); ?>

                            </div>
                            <a href="<?php echo e(route('journals.call-for-papers', $journal)); ?>"
                            ...
                            <div
                                ...
                                <div class="mb-4">
                                    <span
                                        ...
                                        <?php echo e($article->published_at ? \Carbon\Carbon::parse($article->published_at)->format('d M, Y') : 'Recent'); ?>
                                ...
                                <h3
                                    ...
                                    <a
                                        href="<?php echo e(route('journals.article', ['journal' => $journal->slug, 'submission' => $article->id])); ?>">
                                ...
                                <div class="text-xs text-slate-400 mb-6 italic line-clamp-1">
                                    <?php $__currentLoopData = $article->authors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $author): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php echo e($author->full_name); ?><?php if(!$loop->last): ?>, <?php endif; ?>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </div>
                                <div class="mt-auto pt-6 border-t border-slate-50 flex items-center justify-between">
                                    <a href="<?php echo e(route('journals.article', ['journal' => $journal->slug, 'submission' => $article->id])); ?>"
                                        class="text-cisa-base font-bold text-sm">Read More</a>
                                    <div class="flex gap-3">
                                        <a href="<?php echo e(route('journals.article.download', ['journal' => $journal->slug, 'submission' => $article->id])); ?>"
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-16 items-center">
                    <div class="lg:col-span-1">
                        ...
                        <a href="<?php echo e(route('journals.announcements', $journal)); ?>"
                            ...
                            <?php $__currentLoopData = $announcements->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $announcement): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div
                                    ...
                                    <span class="text-cisa-accent text-xs font-bold uppercase tracking-widest mb-2 block">
                                        <?php echo e($announcement->published_at ? \Carbon\Carbon::parse($announcement->published_at)->format('d M, Y') : ''); ?>
                                    ...
                                    <p class="text-gray-400 text-sm line-clamp-2 leading-relaxed">
                                        <?php echo e(strip_tags($announcement->content)); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u857061584/domains/cisajournal.org/public_html/resources/views/journals/show.blade.php ENDPATH**/ ?>