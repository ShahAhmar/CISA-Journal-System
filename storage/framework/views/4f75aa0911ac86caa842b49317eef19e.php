...
<?php $__env->startSection('title', 'Editorial & Ethics - ' . $journal->name); ?>
                ...
                <div class="lg:col-span-8 space-y-20">
                    ...
                    <section id="board">
                        ...
                        <div class="space-y-10">
                            <?php if($journal->editor_in_chief): ?>
                                <div class="bg-slate-50 p-8 rounded-3xl border border-slate-100">
                                    ...
                                    <div class="prose prose-lg max-w-none text-gray-700 leading-relaxed">
                                        <?php echo $journal->editor_in_chief; ?>

                                    </div>
                                </div>
                            <?php endif; ?>

                            <?php if($journal->editorial_board_members): ?>
                                <div class="bg-white p-8 rounded-3xl border-2 border-slate-50 shadow-sm">
                                    ...
                                    <div class="prose prose-lg max-w-none text-gray-700 leading-relaxed">
                                        <?php echo $journal->editorial_board_members; ?>
                            ...
                            <?php if($editors && $editors->count() > 0): ?>
                                <div class="grid grid-cols-1 gap-8">
                                    ...
                                    <div class="flex flex-col md:flex-row gap-8 items-start bg-slate-50/50 p-8 rounded-3xl border border-slate-100 group hover:bg-white hover:shadow-xl transition-all">
                                        <div class="shrink-0">
                                            <?php if($editor->profile_image): ?>
                                                <img src="<?php echo e(asset('storage/' . $editor->profile_image)); ?>" alt="<?php echo e($editor->name); ?>" class="w-24 h-24 rounded-2xl object-cover shadow-lg border-2 border-white group-hover:scale-110 transition-transform">
                                            <?php else: ?>
                                        ...
                                        <div class="flex-grow">
                                            <div class="flex flex-wrap items-center justify-between gap-4 mb-4">
                                                <div>
                                                    <h3 class="text-xl font-bold text-cisa-base"><?php echo e($editor->name); ?></h3>
                                                    <p class="text-cisa-accent font-bold text-sm tracking-widest uppercase"><?php echo e($editor->role); ?></p>
                                                </div>
                                                <?php if($editor->orcid): ?>
                                                <a href="https://orcid.org/<?php echo e($editor->orcid); ?>" target="_blank" class="flex items-center text-xs bg-white px-3 py-1 rounded-full border border-gray-100 hover:text-green-600">
                                                    <i class="fab fa-orcid mr-2 text-green-500"></i> ORCID
                                                </a>
                                                <?php endif; ?>
                                            </div>
                                            <p class="text-gray-600 text-sm leading-relaxed mb-4 font-bold"><?php echo e($editor->affiliation); ?></p>
                            ...
                            <?php if(!$journal->editor_in_chief && !$journal->editorial_board_members && (!$editors || $editors->count() == 0)): ?>
                    ...
                    <section id="ethics" class="bg-white rounded-3xl p-10 border-2 border-slate-50 shadow-sm">
                        ...
                        <div class="prose prose-lg max-w-none text-gray-700 leading-relaxed space-y-6">
                            <?php if($journal->ethics_policy): ?>
                                <?php echo $journal->ethics_policy; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u857061584/domains/cisajournal.org/public_html/resources/views/journals/editorial-ethics.blade.php ENDPATH**/ ?>