...
<div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-purple-50 via-purple-100 to-purple-50 py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
    ...
    <div class="max-w-3xl w-full relative z-10">
        ...
        <div class="bg-white rounded-2xl shadow-2xl border-t-4 border-t-purple-600 p-8 transform hover:shadow-3xl transition-all duration-300">
            <form class="space-y-6" method="POST" action="<?php echo e(route('register')); ?>" id="registerForm" 
                  x-data="{ 
                      showPassword: false, 
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input id="first_name" name="first_name" type="text" required 
                               class="w-full px-4 py-4 border-2 border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-all duration-300 <?php echo e($errors->has('first_name') ? 'border-red-500 focus:ring-red-500 focus:border-red-500' : ''); ?>" 
                               placeholder="John" 
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input id="last_name" name="last_name" type="text" required 
                               class="w-full px-4 py-4 border-2 border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-all duration-300 <?php echo e($errors->has('last_name') ? 'border-red-500 focus:ring-red-500 focus:border-red-500' : ''); ?>" 
                               placeholder="Doe" 
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input id="password_confirmation" name="password_confirmation" 
                                   ...
                                   required 
                                   class="w-full px-4 py-4 pl-12 pr-12 border-2 border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-all duration-300 <?php echo e($errors->has('password_confirmation') ? 'border-red-500 focus:ring-red-500 focus:border-red-500' : ''); ?>" 
...
unset($__errorArgs, $__bag); ?>
                ...
                <!-- Login Link -->
                <div>
                    <a href="<?php echo e(route('login')); ?>" class="w-full bg-white border-2 border-purple-600 text-purple-600 hover:bg-purple-50 font-bold py-4 px-6 rounded-xl shadow-md hover:shadow-lg transform hover:scale-[1.02] active:scale-[0.98] transition-all duration-300 inline-flex items-center justify-center">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\cisa\resources\views/auth/register.blade.php ENDPATH**/ ?>