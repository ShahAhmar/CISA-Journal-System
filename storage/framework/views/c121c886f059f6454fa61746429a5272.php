...
<?php $__env->startSection('title', 'Journal Information - ' . $journal->name); ?>
                    ...
                    <section id="identity">
                        ...
                        <div
                            ...
                            <div class="bg-white p-8">
                                ...
                                <p class="text-lg font-serif font-bold text-cisa-base"><?php echo e($journal->name); ?></p>
                            </div>
                            <div class="bg-white p-8">
                            ...
                            <div class="bg-white p-8">
                                ...
                                <p class="text-lg font-mono font-bold text-gray-800">
                                    <?php echo e($journal->online_issn ?: 'Not assigned yet'); ?>
                            ...
                            <div class="bg-white p-8">
                                ...
                                <p class="text-lg font-mono font-bold text-gray-800">
                                    <?php echo e($journal->print_issn ?: 'Not available'); ?>
                            ...
                            <div class="bg-white p-8">
                                ...
                                <div class="text-lg font-bold text-gray-800">
                                    <?php echo $journal->peer_review_process ?: 'Not specified'; ?>
                            ...
                            <div class="bg-white p-8">
                                ...
                                <div class="text-lg font-bold text-gray-800">
                                    <?php echo $journal->publication_frequency ?: 'Not specified'; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u857061584/domains/cisajournal.org/public_html/resources/views/journals/info.blade.php ENDPATH**/ ?>