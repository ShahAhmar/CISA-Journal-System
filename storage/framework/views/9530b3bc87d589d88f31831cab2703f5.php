...
<?php $__env->startSection('title', 'Admin Dashboard | CISA'); ?>
<?php $__env->startSection('page-title', 'Admin Dashboard'); ?>
<?php $__env->startSection('page-subtitle', 'Comprehensive overview of your journal publishing platform'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
        ...
        <a href="<?php echo e(route('admin.journals.index')); ?>"
            ...
            <div class="flex items-center justify-between mb-4">
                ...
                <div class="text-right">
                    <div
                        class="text-3xl font-serif font-bold text-cisa-base group-hover:text-cisa-accent transition-colors">
                        <?php echo e($stats['active_journals']); ?></div>
        ...
        <a href="<?php echo e(route('admin.submissions.index')); ?>"
            ...
            <div class="flex items-center justify-between mb-4">
                ...
                <div class="text-right">
                    <div
                        class="text-3xl font-serif font-bold text-cisa-base group-hover:text-cisa-accent transition-colors">
                        <?php echo e($stats['submissions']); ?></div>
        ...
        <!-- Pending Submissions -->
        <a href="<?php echo e(route('admin.submissions.index', ['status' => 'submitted'])); ?>"
            class="group bg-white rounded-xl p-6 border border-gray-100 shadow-sm hover:shadow-lg hover:border-cisa-accent transition-all duration-300 transform hover:-translate-y-1">
            <div class="flex items-center justify-between mb-4">
                <div
                ...
                <div class="text-right">
                    <div
                        class="text-3xl font-serif font-bold text-cisa-base group-hover:text-cisa-accent transition-colors">
                        <?php echo e($stats['pending_submissions']); ?></div>
        ...
        <!-- Published Articles -->
        <a href="<?php echo e(route('admin.submissions.index', ['status' => 'published'])); ?>"
            class="group bg-white rounded-xl p-6 border border-gray-100 shadow-sm hover:shadow-lg hover:border-cisa-accent transition-all duration-300 transform hover:-translate-y-1">
            <div class="flex items-center justify-between mb-4">
                <div
                ...
                <div class="text-right">
                    <div
                        class="text-3xl font-serif font-bold text-cisa-base group-hover:text-cisa-accent transition-colors">
                        <?php echo e($stats['published_articles']); ?></div>
            ...
            <div class="p-6">
                                ...
                                <div class="flex items-center space-x-4">
                                    ...
                                    <div>
                                        <h4 class="font-bold text-cisa-base text-sm group-hover:text-cisa-accent transition-colors">
                                            <?php echo e(Str::limit(strip_tags($journal->name), 30)); ?></h4>
                                        <p class="text-xs text-gray-500"><?php echo e($journal->created_at->format('M d, Y')); ?></p>
                                    </div>
                                </div>
                                <div class="flex items-center space-x-3">
                                    <span
                                        class="px-2 py-1 rounded text-[10px] font-bold uppercase tracking-wider <?php echo e($journal->is_active ? 'bg-green-100 text-green-700' : 'bg-gray-200 text-gray-600'); ?>">
                ...
                <?php else: ?>
                    <div class="text-center py-8">
                        ...
                        <a href="<?php echo e(route('admin.journals.create')); ?>" class="btn-cisa-primary py-2 px-4 text-xs">
                                ...
                                <tr class="hover:bg-slate-50 transition-colors">
                                    <td class="py-3 px-6">
                                        <div class="font-bold text-cisa-base text-sm mb-0.5">
                                            <?php echo e(Str::limit($submission->title, 25)); ?></div>
                                        <div class="text-[11px] text-gray-400">
                                            <?php echo e(Str::limit($submission->author->full_name ?? 'N/A', 20)); ?></div>
                                    </td>
                                    <td class="py-3 px-6">
                                    ...
                                    <td class="py-3 px-6 text-xs text-gray-500 font-mono">
                                        <?php echo e($submission->created_at->format('M d')); ?></td>
                                </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </tbody>
                    </table>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-0 divide-y md:divide-y-0 md:divide-x divide-gray-100">
            ...
            <a href="<?php echo e(route('admin.reviews.index')); ?>?status=pending"
                ...
                <div class="flex flex-col md:flex-row items-center md:items-start justify-between mb-4">
                    ...
                    <span
                        class="text-3xl font-serif font-bold text-cisa-base group-hover:text-cisa-accent transition-colors"><?php echo e($pendingTasks['review_requests'] ?? 0); ?></span>
                </div>
            ...
            <a href="<?php echo e(route('admin.submissions.index', ['status' => 'revision_required'])); ?>"
                class="p-8 hover:bg-slate-50 transition-colors group text-center md:text-left">
                <div class="flex flex-col md:flex-row items-center md:items-start justify-between mb-4">
                    <div
                    ...
                    <span
                        class="text-3xl font-serif font-bold text-cisa-base group-hover:text-cisa-accent transition-colors"><?php echo e($pendingTasks['revision_submissions'] ?? 0); ?></span>
                </div>
            ...
            <a href="<?php echo e(route('admin.submissions.index', ['status' => 'submitted'])); ?>"
                ...
                <div class="flex flex-col md:flex-row items-center md:items-start justify-between mb-4">
                    ...
                    <span
                        class="text-3xl font-serif font-bold text-cisa-base group-hover:text-cisa-accent transition-colors"><?php echo e($pendingTasks['decisions_required'] ?? 0); ?></span>
                </div>
        ...
        <div class="space-y-4">
            <div class="flex items-start space-x-4 p-4 bg-slate-50 rounded-lg border border-gray-100">
                ...
                <div class="flex-1">
                    <p class="text-sm text-gray-700 font-medium">
                        <span class="text-cisa-base font-bold"><?php echo e(auth()->user()->full_name); ?></span> accessed the admin
                        dashboard
                    </p>
                    <p class="text-xs text-gray-400 mt-1"><?php echo e(now()->format('M d, Y h:i A')); ?></p>
                </div>
            </div>
            ...
            <div class="flex items-start space-x-4 p-4 bg-slate-50 rounded-lg border border-gray-100">
                ...
                <div class="flex-1">
                    ...
                    <p class="text-xs text-gray-400 mt-1"><?php echo e(now()->subHours(5)->format('M d, Y h:i A')); ?></p>
                </div>
            </div>
        </div>
    </div>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u857061584/domains/cisajournal.org/public_html/resources/views/admin/dashboard.blade.php ENDPATH**/ ?>